...
function TaylorD( pi , bt , ph )
 {
    ...
    if( pi == 0 )
     {
      ...
      if( ((btl === undefined) && (phl === undefined)) || ((Math.abs( btl - taylord[i][c_bt] ) >= Math.abs( bt - taylord[i][c_bt] )) && (Math.abs( phl - taylord[i][c_ph] ) >= Math.abs( ph - taylord[i][c_ph] ))) )
       {
      ...
      else if( ((btr === undefined) && (phr === undefined)) || ((Math.abs( btr - taylord[i][c_bt] ) >= Math.abs( bt - taylord[i][c_bt] )) && (Math.abs( phr - taylord[i][c_ph] ) >= Math.abs( ph - taylord[i][c_ph] ))) )
       {
  ...
  return( [ [ pil , btl , phl , pir , btr , phr ] ] ) ;
